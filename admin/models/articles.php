...
/**
 * Class DD_NewstickerModelArticles
 *
 * @since  Version 1.0.0.0
 */
class DD_NewstickerModelArticles extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.title, a.catid, a.state, a.eventdate, a.publish_up, a.publish_down'
			)
		);

		$query->from($db->qn('#__dd_newsticker', 'a'));
